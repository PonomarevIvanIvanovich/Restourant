...
// MARK: - Setup action
    ...
    private func appendPromoSection() {
        promoSectionCollectionView.set(cell: PromoSectionModel.fetchPromo())
        promoBannerCollection.set(cell: PromoBannerModel.fetchPromo())
        discountProductCollectionView.set(cell: DiscountProductModel.fetchPromo())
        catalogCollectionView.set(cell: CatalogModel.fetchPromo())
    }
